...
import 'mini_desktop_home_page_center_pane_article_card.dart';

class MiniDeskBodyCenterPaneArticleSection extends StatefulWidget {
  const MiniDeskBodyCenterPaneArticleSection({Key? key}) : super(key: key);
...
class _BodyCenterPaneArticleSectionState
    extends State<MiniDeskBodyCenterPaneArticleSection> {
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: MiniDeskHomePageCenterPaneArticleCard(
                                        index: index,
