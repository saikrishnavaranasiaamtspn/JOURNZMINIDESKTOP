...
class MiniDeskBodyCenterPaneSubtypeHeader extends StatefulWidget {
  //final ShowCurrentlySelectedSubtypeCubit showCurrentSubtypeNameCubit;
  const MiniDeskBodyCenterPaneSubtypeHeader({
    Key? key,
...
class _BodyCenterPaneSubtypeHeaderState
    extends State<MiniDeskBodyCenterPaneSubtypeHeader> {
  int all = 0;
  int favourite = 1;
  @override
