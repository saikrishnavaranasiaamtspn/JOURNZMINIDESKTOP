...
class MiniDeskHomePageHeader extends StatefulWidget {
  final bool? wantSearchBar;
  const MiniDeskHomePageHeader({Key? key, this.wantSearchBar}) : super(key: key);

  @override
  _HomePageHeaderState createState() => _HomePageHeaderState();
}

class _HomePageHeaderState extends State<MiniDeskHomePageHeader> {
        ...
        //  SizedBox(width: context.screenWidth * 0.15),
          ...
          BlocBuilder<CheckuserloginedCubit, CheckuserloginedState>(
            builder: (context, userState) {
              return !userState.isLoggined!
                  ...
                  style: ButtonStyle(
                    ...
                    MaterialStateProperty.resolveWith<Color>(
                          ...
                          if (states.contains(MaterialState.pressed))
                            return Colors.blue.shade100;
                          return Colors.blue
                              .shade400; // null throus error in flutter 2.2+.
                        }),
                    foregroundColor:
                    MaterialStateProperty.resolveWith<Color>(
                            (Set<MaterialState> states) {
                ...
                widget.wantSearchBar!
                  ...
                  style: ButtonStyle(
                    ...
                    : Container()
              ]).box.width(context.screenWidth * 0.25).make()
                  : widget.wantSearchBar!
                  ? ElevatedButton(
                onPressed: () {
              ...
              ).box.width(context.screenWidth * 0.055).make()
                  : Container();
            },
          ),
